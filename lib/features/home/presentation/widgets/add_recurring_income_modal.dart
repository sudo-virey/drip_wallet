...
class AddRecurringIncomeModal extends StatefulWidget {
  final VoidCallback onSuccess;

  const AddRecurringIncomeModal({
    super.key,
    required this.onSuccess,
  });

  @override
  State<AddRecurringIncomeModal> createState() => _AddRecurringIncomeModalState();
}

class _AddRecurringIncomeModalState extends State<AddRecurringIncomeModal> {
  ...
  void _submitForm() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Ingreso fijo creado exitosamente'),
              ...
              child: Column(
                ...
                children: [
                  ...
                  DescriptionField(
                    ...
                    hintText: 'ej: Sueldo, Freelance, Bono, Comisión',
                  ),
