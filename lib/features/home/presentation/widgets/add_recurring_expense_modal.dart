...
class AddRecurringExpenseModal extends StatefulWidget {
  ...
  @override
  State<AddRecurringExpenseModal> createState() => _AddRecurringExpenseModalState();
}

class _AddRecurringExpenseModalState extends State<AddRecurringExpenseModal> {
  ...
  void _submitForm() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Gasto fijo creado exitosamente'),
