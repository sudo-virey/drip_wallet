...
class EditIncomeTransactionModal extends StatefulWidget {
  final TransactionEntity transaction;

  const EditIncomeTransactionModal({
    super.key,
    required this.transaction,
  });

  @override
  State<EditIncomeTransactionModal> createState() =>
      _EditIncomeTransactionModalState();
}

class _EditIncomeTransactionModalState
    extends State<EditIncomeTransactionModal> {
      ...
      if (mounted) {
        setState(() {
          ...
          final validCategoryNames =
              _incomeCategories.map((c) => c['name'] as String).toList();
